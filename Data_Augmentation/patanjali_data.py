...
def generate_augmented_data(row):
    ...
    system_prompt = (
        "You are an expert on the Patanjali Yoga Sutras, providing clear and accurate responses to questions. "
        "Based on the provided chapter, verse, Sanskrit text, and translation, generate a concise and precise answer to the question. "
    ...
    try:
        ...
        # Append the Sanskrit sloka after the generated response
        sloka = row['sanskrit']
...
if __name__ == "__main__":
    input_csv = r'NYD_Hackathon\Data\Patanjali_Yoga_Sutras\Patanjali_Yoga_Sutras_Verses_English_Questions.csv' 
    output_csv = r'NYD_Hackathon\Data\Patanjali_Yoga_Sutras\Patanjali_Yoga_Sutras_Verses_English_Questions_augmented_appended.csv'  
